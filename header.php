<!doctype html>
  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
		...
		<link rel="alternate" href="https://pregelecuador.com/" hreflang="es-ec" />
		...
		<!-- Google Analytics - PreGel Ecuador -->
		...
		<script>
		 ...
		 ga('create', 'UA-4623260-12', 'auto', {'allowLinker': true});
		 ga('require', 'linker');
         ga('linker:autoLink', ['https://ecuador.pregel-itc.com/'] );
		 ga('send', 'pageview');
